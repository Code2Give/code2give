  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold tracking-tight text-slate-900">City Planner Dashboard</h2>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl border border-red-200 bg-red-50 p-6 shadow-sm">
          <div className="font-medium text-red-800 mb-1">Critical Priority Tracts</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="font-medium text-slate-500 mb-1">Total SNAP Need Met</div>
          <div className="text-3xl font-bold text-slate-900">42%</div>
          <div className="text-sm text-amber-600 mt-2">NYC Average</div>
        </div>
        <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="font-medium text-slate-500 mb-1">New Pantries Needed</div>
          <div className="text-3xl font-bold text-slate-900">28</div>
          <div className="text-sm text-slate-500 mt-2">To reach baseline coverage</div>
        </div>
      </div>
